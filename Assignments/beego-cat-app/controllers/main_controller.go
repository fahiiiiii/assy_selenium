...
// 	c.TplName = "favorites.html" // Render the favorites.html template
// }

// func (c *MainController) ShowBreeds() {
// 	c.TplName = "breeds.html" // Render the breeds.html template
// }

// func (c *MainController) ShowVoting() {
// 	c.TplName = "voting.html" // Render the voting.html template
// }
package controllers
